const FreeCard = () => {
  return (
    <div className="relative mt-14 flex w-[250px] justify-center rounded-[20px] bg-[#eaecef] dark:bg-[#2b3139]  pb-4">
      <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-[#f7a600] ">
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        ...
        <p className="mt-1 px-4 text-center text-sm ">
          Improve your trading process and start doing more with Minta
         
        </p>

        <a
          target="blank"
          className="text-medium mt-7 block rounded-full bg-[#f7a600]  py-[12px] px-11 text-center text-base text-black hover:bg-gradient-to-b hover:from-white/40 hover:to-white/5 "
